...
const EMAILJS_TEMPLATE_ID = "template_vdgwdld";
...
// initialize
  ...
  form.addEventListener('submit', function(e){
    ...
    if(!validate()) {
      ...
      return; //agr validation fail ho jaye to neeche ka code tun nahi hooga.
    }
...
function validate() {
  ...
  // Asaian names can be three-letter names such as Lee or Mae hence, limit >=3.
  if(name.length < 3) {
